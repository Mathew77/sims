    ...
    class SummaryModal extends Model {
        ...
        public function cctSummary($state, $period, $user_id, $user_lga)
        {
            ...
            $StringData = Parent::SeperateToString($user_lga);
             $myQuery = "SELECT ms_lga.Fullname AS LGA, 
                        ...
                        AND  cct_ms_beneficiary.lgaid IN (SELECT LgaId FROM ms_lga WHERE StateId=$state AND Fullname IN ($StringData))
        ...
        public function geeSummary($state, $period, $user_id, $user_lga)
        {
            ...
            $myQuery = "SELECT ms_lga.Fullname AS LGA, 
                            ...
                            AND  gee_ms_beneficiary.lgaid IN (SELECT LgaId FROM ms_lga WHERE StateId=$state AND Fullname IN ($StringData))
                            GROUP BY ms_lga.Fullname";
            }else{
                $myQuery = "SELECT ms_lga.Fullname AS LGA, 
                            ms_lga.LgaId AS lga_id,
        ...
        public function npoSummary($state, $period, $user_id, $user_lga)
        {
            ...
            $myQuery = "SELECT ms_lga.Fullname AS LGA, 
                        ...
                        AND  npo_ms_beneficiary.lgaid IN (SELECT LgaId FROM ms_lga WHERE StateId=$state AND Fullname IN ($StringData))
        ...
        public function sfpSummary($state, $period, $user_id, $user_lga)
        {
            ...
            $StringData = Parent::SeperateToString($user_lga);
             ...
             $myQuery = "SELECT ms_lga.Fullname AS LGA, 
                        ...
                        AND  sfp_ms_beneficiary.lgaid IN (SELECT LgaId FROM ms_lga WHERE StateId=$state AND Fullname IN ($StringData))
